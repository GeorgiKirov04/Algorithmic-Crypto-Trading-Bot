...
timeframe = '5m'
since = exchange.milliseconds() - 1000 * 60 * 60 * int(timeframe[:-1]) * 255
...
fourty_percent_of_wallet =0.4*starting_money
hold_the_btc = 0
...
for i in range(len(df)):
    ...
    if macd[i] < 0 and macdsignal[i] < 0 and macd[i] > macdsignal[i] and macd[i-1] < macdsignal[i-1] and df['open'][i+1] > ema_50[i+1]: 
        ...
        if in_position == False and hold_the_btc!=0:
            trend_up = True
            trend_down = False      
            if trend_up :
                profit_ratio = 1.5
                ...
                purchase_amount = hold_the_btc  / purchase_price
                ...
                hold_all_btc_investments+=purchase_amount
        ...
        #     if fourty_percent_of_wallet!=0:
        #         purchase_price = df['low'][i+1]
        #         if count==0:
        #             purchase_amount = (fourty_percent_of_wallet/2) / purchase_price
        #             buy_signal.append(i)
        #             fourty_percent_of_wallet-=(purchase_amount*purchase_price)
        #             print("________________")
        #             print(f"Bought {purchase_amount:.8f} BTC at {purchase_price:.2f} USDT each ")
        #             print(f"Bought for the first 200$ HERE")
        #             print("________________")
        #             count+=1
        #         elif count>=1 :   
        #                 purchase_amount = (fourty_percent_of_wallet) / purchase_price
        #                 print("________________")
        #                 print(f"All fourty percent of the wallet are equal to: {fourty_percent_of_wallet}")
        #                 #print(f"Bought {purchase_amount:.8f} BTC at {purchase_price:.2f} USDT each ")
        #                 print(f"Bought {purchase_amount:.8f} BTC at {purchase_price:.2f} USDT each ")
        #                 buy_signal.append(i)
        #                 fourty_percent_of_wallet-=(purchase_amount*purchase_price)
        #                 print(f"Left % of the fourty: {fourty_percent_of_wallet:.2f}")
        #                 print("________________")
        #         in_position==True  
            ...
            if sell_price_for_prof > purchase_price:
                ...
                hold_the_btc += money_to_buy
                #fourty_percent_of_wallet+=fourty_percent_of_wallet
                total_p+=profit
...
print(f'money in the wallet: {starting_money:.2f}')
